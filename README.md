...
## توجه <br>
<p dir="rtl">:new: در آپدیت های جدید فریم ورک به لاراول تغییر کرده است</p>
<p dir="rtl">:warning: در صورت استفده از ورژن های 3.6 و پایینتر از آن قبل از آپدیت از پنل خود بک آپ تهیه کنید</p>
<p dir="rtl">:floppy_disk: در سرور قدیمی از قسمت ادمین > تنظیمات > بک آپ : از سرور بک آپ تهیه کنید و بک آپ تهیه شده را دانلود نمایید
سپس در سرور جدید از همین مسیر در بخش backup > Import Only Users را انتخاب و بک آپ دانلود شده را بارگذاری کنید.</p>
